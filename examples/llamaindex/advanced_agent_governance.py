...
def simulate_research_agent_workflow(tracker: GenOpsAgentWorkflowTracker) -> None:
    ...
    print(f"🤖 Agent: Business Research Assistant")
    print(f"📋 Task: Analyze Q3 2024 performance and create recommendations")
...
def simulate_customer_support_agent_workflow(tracker: GenOpsAgentWorkflowTracker) -> None:
    ...
    print(f"🤖 Agent: Customer Support Assistant")
    print(f"🎫 Ticket: Enterprise customer asking about pricing tiers and feature comparison")
...
def simulate_budget_constrained_workflow(tracker: GenOpsAgentWorkflowTracker) -> None:
    ...
    print(f"📋 Task: Quick market analysis with strict cost controls")
    ...
    if projected_final_cost > remaining_budget:
        ...
        print(f"   🔄 Switching to template-based response...")
