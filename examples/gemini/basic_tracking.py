...
def main():
    ...
    try:
        ...
        print(f"✅ AI Research Team Operation:")
        ...
        print(f"   🏷️  Team: ai-research | Project: ml-education")
        print()
        ...
        print(f"✅ Sales Analytics Team Operation:")
        ...
        print(f"   🏷️  Team: sales-analytics | Project: quarterly-reports")
        print()
