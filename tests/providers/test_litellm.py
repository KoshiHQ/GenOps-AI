...
from src.genops.providers.litellm import (
...
class TestGenOpsLiteLLMCallback:
    ...
    @patch('src.genops.providers.litellm._global_usage_stats')
    ...
    def test_success_callback(self, mock_stats):
        ...
        with patch('src.genops.providers.litellm._calculate_cost') as mock_calc_cost:
...
class TestAutoInstrumentation:
    ...
    def test_auto_instrument_basic(self):
        ...
        with patch('src.genops.providers.litellm.litellm') as mock_litellm:
    ...
    def test_auto_instrument_litellm_not_available(self):
        ...
        with patch('src.genops.providers.litellm.litellm', None):
    ...
    def test_auto_instrument_exception_handling(self):
        ...
        with patch('src.genops.providers.litellm.litellm') as mock_litellm:
            ...
            mock_litellm.success_callback.append.side_effect = Exception("Registration failed")
...
class TestTrackCompletion:
    ...
    def test_track_completion_context_manager(self):
        ...
        with patch('src.genops.providers.litellm._global_usage_stats') as mock_stats:
            mock_stats.add_request = Mock()
...
class TestCostCalculation:
    ...
    def test_calculate_cost_openai_gpt35(self):
        ...
        from src.genops.providers.litellm import _calculate_cost
...
class TestProviderInference:
    ...
    def test_infer_provider_openai_models(self):
        ...
        from src.genops.providers.litellm import _infer_provider_from_model
...
class TestEdgeCases:
    ...
    def test_callback_with_malformed_response(self):
        ...
        with patch('src.genops.providers.litellm._global_usage_stats') as mock_stats:
            ...
            try:
                ...
                pytest.fail(f"Callback should handle malformed response gracefully: {e}")
    ...
    def test_concurrent_auto_instrumentation(self):
        ...
        with patch('src.genops.providers.litellm.litellm') as mock_litellm:
            ...
            for i in range(5):
                thread = threading.Thread(target=lambda: results.append(instrument_thread()))
                threads.append(thread)
                thread.start()
...
class TestIntegrationScenarios:
    ...
    @patch('src.genops.providers.litellm.litellm')
    def test_multi_provider_workflow(self, mock_litellm):
        ...
        summary = get_cost_summary(group_by="provider")
        assert len(summary["cost_by_provider"]) >= len(set(p[0] for p in providers_scenarios))
    ...
    def test_cost_optimization_workflow(self):
        ...
        for provider, model, cost, input_tokens, output_tokens, team in optimization_requests:
            with _usage_lock:
                _global_usage_stats.add_request(
                    provider=provider,
                    model=model, 
